...
function lazord.get(c, opts)
  ...
  return {
    ...
    BufferAlternate       = { bg = c.bg_highlight, fg = c.fg },
    BufferAlternateERROR  = { bg = c.bg_highlight, fg = c.error },
    BufferAlternateHINT   = { bg = c.bg_highlight, fg = c.hint },
    BufferAlternateIndex  = { bg = c.bg_highlight, fg = c.info },
    BufferAlternateINFO   = { bg = c.bg_highlight, fg = c.info },
    BufferAlternateMod    = { bg = c.bg_highlight, fg = c.warning },
    BufferAlternateSign   = { bg = c.bg_highlight, fg = c.info },
    BufferAlternateTarget = { bg = c.bg_highlight, fg = c.red },
    BufferAlternateWARN   = { bg = c.bg_highlight, fg = c.warning },
    ...
    BufferInactive        = { bg = Util.darken(c.bg_highlight, 0.4), fg = Util.darken(c.purple, 0.8) },
    ...
    BufferInactiveIndex   = { bg = Util.darken(c.bg_highlight, 0.4), fg = c.purple },
    ...
    BufferTabpageFill     = { bg = Util.darken(c.bg_highlight, 0.8), fg = c.purple },
